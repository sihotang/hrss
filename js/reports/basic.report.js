...
var reportBasic = {
    ...
    content: [{
            text: PageInfo.user.empno.value,
            style: 'header'
        },
        PageInfo.user.empno.value + 'Official documentation is in progress, this document is just a glimpse of what is possible with pdfmake and its layout engine.', {
